...
//                   | Esc | Spc | Tab |   | Ent | Spc | Bsp |
//                   '-----------------'   '-----------------'
#define _________THUMB_L_________ LGUI_T(KC_ESC)  , LT(_LWR, KC_SPC)  , LT(_NUM, KC_TAB)
#define _________THUMB_R_________ LT(_MOUSE, KC_ENT), LT(_RAISE, KC_SPC), RALT_T(KC_BSPC)
